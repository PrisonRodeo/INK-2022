##############################################
# This is some code from the March 2022
# workshop on quantitative text analysis, 
# conducted for HONS 261 at Susquehanna
# University. It is designed to  provide a 
# very basic introduction to the R 
# language, which is the language used for
# the computing components of the workshop.
#
# File created December 14, 2021.
#
# File last updated March 9, 2022.
###############################################
# Basics: OBJECTS
#
...
# READING IN DATA
#
# For statistics, most of the time you won't want 
# to enter numeric data by hand. Instead, you will 
...
# decided during OT 1946-2020 and
...
# the data, using a command in the -readr-
# package called -read_csv-:

SCOTUS <- read_csv("https://raw.githubusercontent.com/PrisonRodeo/INK-2022/main/Data/SCOTUS-votes.csv")
...
# the columns of SCOTUS, but such that 
# it only includes the rows that represent 
# GOP appointees." We can see that the
# command worked:
